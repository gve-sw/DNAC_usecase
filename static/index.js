...
topology.on("ready", function(){
	...
	topology.on("topologyGenerated", function() {
        ...
        var nodes3 = [nodesDict.getItem("Port5"),nodesDict.getItem("Port3")];
        ...
        var nodes4 = [nodesDict.getItem("Port2"),nodesDict.getItem("Port4"),nodesDict.getItem("Port1"),nodesDict.getItem("Port0")]; //find and replace 
